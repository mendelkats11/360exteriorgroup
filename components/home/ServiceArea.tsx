...
export function ServiceArea() {
  return (
    <section className="relative overflow-hidden bg-white py-24">
      <div className="pointer-events-none absolute -right-40 top-1/2 h-96 w-96 -translate-y-1/2 rounded-full bg-orange-100/55 blur-3xl" />
      <Container className="relative">
        <div className="grid grid-cols-1 items-center gap-14 lg:grid-cols-2">
          <FadeIn>
            ...
            <div className="mt-8 grid grid-cols-2 gap-3 sm:grid-cols-3">
              {siteConfig.serviceAreas.map((area) => (
                <div key={area} className="flex items-center gap-2 text-sm font-medium text-slate-700">
          ...
          <FadeIn delay={0.15}>
            <div className="relative aspect-square w-full overflow-hidden rounded-3xl shadow-xl shadow-orange-900/10 sm:aspect-[4/3]">
              <iframe
